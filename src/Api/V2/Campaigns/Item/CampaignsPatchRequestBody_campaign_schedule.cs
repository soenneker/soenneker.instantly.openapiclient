...
namespace Soenneker.Instantly.OpenApiClient.Api.V2.Campaigns.Item
{
    ...
    public partial class CampaignsPatchRequestBody_campaign_schedule : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        /// </summary>
        public CampaignsPatchRequestBody_campaign_schedule()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Instantly.OpenApiClient.Api.V2.Campaigns.Item.CampaignsPatchRequestBody_campaign_schedule"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Instantly.OpenApiClient.Api.V2.Campaigns.Item.CampaignsPatchRequestBody_campaign_schedule CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Instantly.OpenApiClient.Api.V2.Campaigns.Item.CampaignsPatchRequestBody_campaign_schedule();
        }
        /// <summary>
