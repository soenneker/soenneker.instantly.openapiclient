...
namespace Soenneker.Instantly.OpenApiClient.Api.V2.Webhooks.Item
{
    ...
    public partial class WebhooksPatchRequestBody : IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Instantly.OpenApiClient.Api.V2.Webhooks.Item.WebhooksPatchRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Instantly.OpenApiClient.Api.V2.Webhooks.Item.WebhooksPatchRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Instantly.OpenApiClient.Api.V2.Webhooks.Item.WebhooksPatchRequestBody();
        }
        /// <summary>
