...
namespace Soenneker.Instantly.OpenApiClient.Api.V2.Accounts
{
    ...
    public partial class AccountsPostRequestBody_warmup_advanced : IAdditionalDataHolder, IParsable
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Instantly.OpenApiClient.Api.V2.Accounts.AccountsPostRequestBody_warmup_advanced"/> and sets the default values.
        /// </summary>
        public AccountsPostRequestBody_warmup_advanced()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Instantly.OpenApiClient.Api.V2.Accounts.AccountsPostRequestBody_warmup_advanced"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Instantly.OpenApiClient.Api.V2.Accounts.AccountsPostRequestBody_warmup_advanced CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Instantly.OpenApiClient.Api.V2.Accounts.AccountsPostRequestBody_warmup_advanced();
        }
        /// <summary>
