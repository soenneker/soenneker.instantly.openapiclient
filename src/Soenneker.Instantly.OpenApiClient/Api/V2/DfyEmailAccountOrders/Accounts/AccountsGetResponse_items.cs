...
namespace Soenneker.Instantly.OpenApiClient.Api.V2.DfyEmailAccountOrders.Accounts
{
    ...
    public partial class AccountsGetResponse_items : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public string LastName { get; set; }
#endif
        /// <summary>The password of the account (returned only if `with_passwords` is true). This field can be empty if the accounts are not ready yet.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Instantly.OpenApiClient.Api.V2.DfyEmailAccountOrders.Accounts.AccountsGetResponse_items"/> and sets the default values.
        /// </summary>
        public AccountsGetResponse_items()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Instantly.OpenApiClient.Api.V2.DfyEmailAccountOrders.Accounts.AccountsGetResponse_items"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Instantly.OpenApiClient.Api.V2.DfyEmailAccountOrders.Accounts.AccountsGetResponse_items CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Instantly.OpenApiClient.Api.V2.DfyEmailAccountOrders.Accounts.AccountsGetResponse_items();
        }
        /// <summary>
