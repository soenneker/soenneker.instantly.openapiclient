...
namespace Soenneker.Instantly.OpenApiClient.Api.V2.Leads.Move
{
    ...
    public partial class MoveRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <exception cref="global::Soenneker.Instantly.OpenApiClient.Models.MoveLeads401Response">When receiving a 401 status code</exception>
        /// <exception cref="global::Soenneker.Instantly.OpenApiClient.Models.MoveLeads402Response">When receiving a 402 status code</exception>
        /// <exception cref="global::Soenneker.Instantly.OpenApiClient.Models.MoveLeads404Response">When receiving a 404 status code</exception>
...
#nullable restore
        ...
        public async Task<global::Soenneker.Instantly.OpenApiClient.Models.BackgroundJob> PostAsync(global::Soenneker.Instantly.OpenApiClient.Models.MoveLeadsRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "401", global::Soenneker.Instantly.OpenApiClient.Models.MoveLeads401Response.CreateFromDiscriminatorValue },
                { "402", global::Soenneker.Instantly.OpenApiClient.Models.MoveLeads402Response.CreateFromDiscriminatorValue },
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Soenneker.Instantly.OpenApiClient.Models.MoveLeadsRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Soenneker.Instantly.OpenApiClient.Models.MoveLeadsRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
