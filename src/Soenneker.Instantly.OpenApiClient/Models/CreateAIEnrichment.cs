...
namespace Soenneker.Instantly.OpenApiClient.Models
{
    ...
    public partial class CreateAIEnrichment : IAdditionalDataHolder, IParsable
...
#nullable enable
        public List<global::Soenneker.Instantly.OpenApiClient.Models.CreateAIEnrichment_filters>? Filters { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Instantly.OpenApiClient.Models.CreateAIEnrichment_filters> Filters { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.Instantly.OpenApiClient.Models.CreateAIEnrichment_model_version? ModelVersion { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Instantly.OpenApiClient.Models.CreateAIEnrichment"/> and sets the default values.
        /// </summary>
        public CreateAIEnrichment()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Instantly.OpenApiClient.Models.CreateAIEnrichment"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Instantly.OpenApiClient.Models.CreateAIEnrichment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Instantly.OpenApiClient.Models.CreateAIEnrichment();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "filters", n => { Filters = n.GetCollectionOfObjectValues<global::Soenneker.Instantly.OpenApiClient.Models.CreateAIEnrichment_filters>(global::Soenneker.Instantly.OpenApiClient.Models.CreateAIEnrichment_filters.CreateFromDiscriminatorValue)?.AsList(); } },
                { "input_columns", n => { InputColumns = n.GetCollectionOfPrimitiveValues<string>()?.AsList(); } },
                { "limit", n => { Limit = n.GetDoubleValue(); } },
                { "model_version", n => { ModelVersion = n.GetEnumValue<global::Soenneker.Instantly.OpenApiClient.Models.CreateAIEnrichment_model_version>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Instantly.OpenApiClient.Models.CreateAIEnrichment_filters>("filters", Filters);
            writer.WriteCollectionOfPrimitiveValues<string>("input_columns", InputColumns);
            writer.WriteDoubleValue("limit", Limit);
            writer.WriteEnumValue<global::Soenneker.Instantly.OpenApiClient.Models.CreateAIEnrichment_model_version>("model_version", ModelVersion);
