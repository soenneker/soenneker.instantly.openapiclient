...
namespace Soenneker.Instantly.OpenApiClient.Models
{
    ...
    public partial class CreateLeadFinderAgentRequestSearchFiltersEmployeeCountItemOneOf3 : IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Instantly.OpenApiClient.Models.CreateLeadFinderAgentRequestSearchFiltersEmployeeCountItemOneOf3"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Instantly.OpenApiClient.Models.CreateLeadFinderAgentRequestSearchFiltersEmployeeCountItemOneOf3 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Instantly.OpenApiClient.Models.CreateLeadFinderAgentRequestSearchFiltersEmployeeCountItemOneOf3();
        }
        /// <summary>
