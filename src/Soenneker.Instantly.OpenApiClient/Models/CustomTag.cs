...
namespace Soenneker.Instantly.OpenApiClient.Models
{
    ...
    public partial class CustomTag : IParsable
    {
...
#nullable restore
        ...
        public string Label { get; set; }
#endif
        /// <summary>Organization ID that owns this custom tag</summary>
        public Guid? OrganizationId { get; private set; }
        /// <summary>Timestamp when the custom tag was created</summary>
        public DateTimeOffset? TimestampCreated { get; private set; }
        /// <summary>Timestamp when the custom tag was last updated</summary>
        ...
        public static global::Soenneker.Instantly.OpenApiClient.Models.CustomTag CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Instantly.OpenApiClient.Models.CustomTag();
        }
        /// <summary>
