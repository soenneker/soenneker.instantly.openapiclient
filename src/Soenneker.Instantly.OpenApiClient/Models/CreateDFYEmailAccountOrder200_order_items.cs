...
namespace Soenneker.Instantly.OpenApiClient.Models
{
    ...
    public partial class CreateDFYEmailAccountOrder200_order_items : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The list of accounts that were ordered for the domain.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Instantly.OpenApiClient.Models.CreateDFYEmailAccountOrder200_order_items_accounts>? Accounts { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Instantly.OpenApiClient.Models.CreateDFYEmailAccountOrder200_order_items_accounts> Accounts { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Instantly.OpenApiClient.Models.CreateDFYEmailAccountOrder200_order_items"/> and sets the default values.
        /// </summary>
        public CreateDFYEmailAccountOrder200_order_items()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Instantly.OpenApiClient.Models.CreateDFYEmailAccountOrder200_order_items"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Instantly.OpenApiClient.Models.CreateDFYEmailAccountOrder200_order_items CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Instantly.OpenApiClient.Models.CreateDFYEmailAccountOrder200_order_items();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "accounts", n => { Accounts = n.GetCollectionOfObjectValues<global::Soenneker.Instantly.OpenApiClient.Models.CreateDFYEmailAccountOrder200_order_items_accounts>(global::Soenneker.Instantly.OpenApiClient.Models.CreateDFYEmailAccountOrder200_order_items_accounts.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.Instantly.OpenApiClient.Models.CreateDFYEmailAccountOrder200_order_items_accounts>("accounts", Accounts);
