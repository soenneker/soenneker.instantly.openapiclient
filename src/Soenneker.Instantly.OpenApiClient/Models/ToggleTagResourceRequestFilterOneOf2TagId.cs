...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Instantly.OpenApiClient.Models.ToggleTagResourceRequestFilterOneOf2TagId"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Instantly.OpenApiClient.Models.ToggleTagResourceRequestFilterOneOf2TagId CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
            var result = new global::Soenneker.Instantly.OpenApiClient.Models.ToggleTagResourceRequestFilterOneOf2TagId();
            if(parseNode.GetEnumValue<global::Soenneker.Instantly.OpenApiClient.Models.ToggleTagResourceRequestFilterOneOf2TagIdOneOf2>() is global::Soenneker.Instantly.OpenApiClient.Models.ToggleTagResourceRequestFilterOneOf2TagIdOneOf2 toggleTagResourceRequestFilterOneOf2TagIdOneOf2Value)
            {
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            if(ToggleTagResourceRequestFilterOneOf2TagIdOneOf2 != null)
            {
