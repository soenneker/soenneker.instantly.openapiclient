...
#nullable enable
        public global::Soenneker.Instantly.OpenApiClient.Models.Def24_conditions? Conditions { get; set; }
#nullable restore
#else
        public global::Soenneker.Instantly.OpenApiClient.Models.Def24_conditions Conditions { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.Instantly.OpenApiClient.Models.Def24_sequences>? Sequences { get; set; }
#nullable restore
#else
        public List<global::Soenneker.Instantly.OpenApiClient.Models.Def24_sequences> Sequences { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Instantly.OpenApiClient.Models.Def24_subsequence_schedule? SubsequenceSchedule { get; set; }
#nullable restore
#else
        public global::Soenneker.Instantly.OpenApiClient.Models.Def24_subsequence_schedule SubsequenceSchedule { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "conditions", n => { Conditions = n.GetObjectValue<global::Soenneker.Instantly.OpenApiClient.Models.Def24_conditions>(global::Soenneker.Instantly.OpenApiClient.Models.Def24_conditions.CreateFromDiscriminatorValue); } },
                { "id", n => { Id = n.GetGuidValue(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "parent_campaign", n => { ParentCampaign = n.GetGuidValue(); } },
                { "sequences", n => { Sequences = n.GetCollectionOfObjectValues<global::Soenneker.Instantly.OpenApiClient.Models.Def24_sequences>(global::Soenneker.Instantly.OpenApiClient.Models.Def24_sequences.CreateFromDiscriminatorValue)?.AsList(); } },
                { "status", n => { Status = n.GetDoubleValue(); } },
                { "subsequence_schedule", n => { SubsequenceSchedule = n.GetObjectValue<global::Soenneker.Instantly.OpenApiClient.Models.Def24_subsequence_schedule>(global::Soenneker.Instantly.OpenApiClient.Models.Def24_subsequence_schedule.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Instantly.OpenApiClient.Models.Def24_conditions>("conditions", Conditions);
            writer.WriteStringValue("name", Name);
            writer.WriteGuidValue("parent_campaign", ParentCampaign);
            writer.WriteCollectionOfObjectValues<global::Soenneker.Instantly.OpenApiClient.Models.Def24_sequences>("sequences", Sequences);
            writer.WriteObjectValue<global::Soenneker.Instantly.OpenApiClient.Models.Def24_subsequence_schedule>("subsequence_schedule", SubsequenceSchedule);
        }
    }
}
